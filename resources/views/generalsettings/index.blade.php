        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('generalsetting.update', Crypt::encrypt($setting->id)) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-input-with-icon-label label="Domain Email (contoh: bebascedera.com)" name="domain_email" icon="ti ti-mail"
                        :value="$setting->domain_email ?? ''" />
                    <x-input-with-icon-label label="Domain WA Gateway (contoh: https://wa.bebascedera.com)" name="domain_wa_gateway"
