...
<head>
    ...
    <title>Login Absensi Online Bebas Cedera</title>

    <meta name="description" content="" />
    
    <!-- PWA Meta Tags -->
    <meta name="application-name" content="Absensi Online">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta name="apple-mobile-web-app-title" content="Absensi Online">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center mb-4 mt-2">
                        <img src="{{ asset('assets/img/logo/logo-bebascedera.png') }}" alt="" width="160">
                    </div>
                    <!-- /Logo -->
                    <h4 class="text-muted text-center"><b>Absensi Online</b></h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-danger d-grid w-100" type="submit">Log in</button>
                        </div>
                    </form>
                   ...
                   <p class="text-muted text-center">
                       <?php echo "<b>Copyright © " . (int)date('Y') . " PT. Fisio Mitra Investama</b>"; ?>
                            </p>
